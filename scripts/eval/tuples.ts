...
export const TUPLES: Tuple[] = [
  ...
  { id: "T06", year: 313,   era: "classical",    density: "medium", complexity: "compound",   hypothesis: "Two events removed in a classical year — cascade coherence." },
  ...
  { id: "T12", year: 1648,  era: "early-modern", density: "medium", complexity: "none",       hypothesis: "Westphalia, none — abstract treaty year: does it stay counterfactual or narrate reality?" },
  ...
  { id: "T19", year: 1989,  era: "contemporary", density: "high",   complexity: "compound",   hypothesis: "Berlin Wall — two events removed; present-day-2025 frame stress." },
